...
export default function AdminPage() {
  ...
  async function loadAuthAndProfile() {
    ...
    if (error || !profileData) {
      ...
      setIsAdmin(false);
      setErrorMessage(
        "Sessão encontrada, mas não foi possível validar o perfil de acesso."
      );
      setAuthLoading(false);
      return;
    }
  ...
  async function handleLogout() {
    ...
    if (error) {
      setErrorMessage(`Erro ao terminar sessão: ${error.message}`);
      setSaving(false);
      return;
    }
  ...
  async function handleCreatePilot(e: FormEvent) {
    ...
    const kartNumber =
      pilotForm.kart_number.trim() === ""
        ? null
        : Number(pilotForm.kart_number);
      ...
      <main className="min-h-screen bg-slate-950 text-white">
        <section className="relative overflow-hidden border-b border-white/10 bg-gradient-to-br from-slate-950 via-slate-900 to-blue-950">
          ...
          <div className="relative mx-auto max-w-5xl px-6 py-20 md:px-10">
            <div className="mx-auto max-w-xl rounded-[28px] border border-white/10 bg-white/5 p-8 shadow-2xl backdrop-blur">
              ...
              <p className="mt-4 text-slate-300">
                Inicia sessão com uma conta autorizada no Supabase Auth.
              </p>
      ...
      <main className="min-h-screen bg-slate-950 px-6 py-20 text-white">
        <div className="mx-auto max-w-4xl rounded-3xl border border-red-400/20 bg-red-500/10 p-8">
          ...
          <p className="mt-3 text-slate-300">
            A conta autenticada não tem permissões de administrador.
          </p>
          <div className="mt-6">
            <button
      ...
      <section className="relative overflow-hidden border-b border-white/10 bg-gradient-to-br from-slate-950 via-slate-900 to-blue-950">
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-16 md:px-10">
          <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
            <div>
              <div className="mb-4 inline-flex items-center rounded-full border border-orange-400/30 bg-orange-500/10 px-4 py-1 text-sm font-medium text-orange-300">
                CMS Karting · Admin Panel Seguro
              </div>
              ...
              <p className="mt-4 max-w-2xl text-slate-300">
                Sessão autenticada com permissões de administrador.
              </p>
              ...
              {profile && (
                <p className="mt-1 text-sm text-slate-500">
                  Sessão: {profile.email || profile.full_name || "Admin"}
                </p>
              )}
            </div>
            ...
            <div className="flex flex-col items-stretch gap-3 sm:flex-row">
             ...
             >
              ...
              <button
                onClick={handleLogout}
                disabled={saving}
                className="rounded-2xl border border-white/10 bg-white/5 px-4 py-3 font-semibold text-white transition hover:bg-white/10 disabled:opacity-60"
              >
                Terminar sessão
              </button>
            </div>
